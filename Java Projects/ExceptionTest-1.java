...
public class ExceptionTest {
    ...
    public static void main(String[] args) {
       ...
       //boolean continuedLoop = true; // starts a loop so the user may fix any issue's that are flagged
       
      // while(continuedLoop != false){
           try{ // read user input and try the calculation.
               ...
               //continuedLoop = false;// input and answer was successful so the loop will end.
           } // end try block
